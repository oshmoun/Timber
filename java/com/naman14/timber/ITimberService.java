 ...
 * Original file: /home/oshmoun/github/Timber/app/src/main/aidl/com/naman14/timber/ITimberService.aidl
 */
package com.naman14.timber;
public interface ITimberService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.naman14.timber.ITimberService
{
private static final java.lang.String DESCRIPTOR = "com.naman14.timber.ITimberService";
...
/**
 * Cast an IBinder object into an com.naman14.timber.ITimberService interface,
 * generating a proxy if needed.
 */
public static com.naman14.timber.ITimberService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.naman14.timber.ITimberService))) {
return ((com.naman14.timber.ITimberService)iin);
}
return new com.naman14.timber.ITimberService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.naman14.timber.helpers.MusicPlaybackTrack _result = this.getCurrentTrack();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
int _arg0;
_arg0 = data.readInt();
com.naman14.timber.helpers.MusicPlaybackTrack _result = this.getTrack(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
private static class Proxy implements com.naman14.timber.ITimberService
{
...
@Override public com.naman14.timber.helpers.MusicPlaybackTrack getCurrentTrack() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.naman14.timber.helpers.MusicPlaybackTrack _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurrentTrack, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.naman14.timber.helpers.MusicPlaybackTrack.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.naman14.timber.helpers.MusicPlaybackTrack getTrack(int index) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.naman14.timber.helpers.MusicPlaybackTrack _result;
...
static final int TRANSACTION_setLockscreenAlbumArt = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
}
...
public com.naman14.timber.helpers.MusicPlaybackTrack getCurrentTrack() throws android.os.RemoteException;
public com.naman14.timber.helpers.MusicPlaybackTrack getTrack(int index) throws android.os.RemoteException;
